package metropolis.shared.xtracted.repository

import metropolis.shared.xtracted.data.*
...
fun update(url: String, table: String, id: Int, setStatement: String, idColumn: DbColumnEditor) : Unit =
    DriverManager.getConnection(url)
        .use {
            val logger: Logger = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME)

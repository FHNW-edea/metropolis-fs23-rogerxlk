package metropolis.shared.xtracted.controller
...
abstract class ControllerBase<S, A : Action>(
    initialState: S,
    ...
    fun handleNextAction(): Job =
        ioScope.launch {
            ...
            if (action.enabled) {
                state =
                    executeAction(action)  // der State erhält einen neuen Wert. Dadurch wird ein Recompose ausgelöst.
            }

...
fun main() {
    ...
    application {
//        cityExplorerController(cityExplorerRepository).initializeUiScope(rememberCoroutineScope())
//        countryExplorerController(countryExplorerRepository).initializeUiScope(rememberCoroutineScope())
        MetropolisWindow(controller = controller)
    }
}
package metropolis.xtracted.xtractedEditor.controller.undo
...
class UndoController<S>(private var debounceStart: S, delay : Long = 200L)
    : metropolis.xtracted.xtractedEditor.controller.ControllerBase<UndoState, UndoAction>(initialState = UndoState(undoAvailable = false,
                                                                     redoAvailable = false)
) {
    ...
    private val undoStackScheduler = metropolis.xtracted.xtractedEditor.controller.Scheduler(delay)

package metropolis.xtractedEditor.repository
...
import metropolis.xtractedEditor.data.Filter
import metropolis.xtractedEditor.data.SortDirective
import metropolis.xtractedEditor.data.asSql
...
fun readIds(url: String, table: String, idColumn: DbColumnEditor, filters: List<Filter<*>>, sortDirective: SortDirective) : List<Int> =
...
fun count(url: String, table: String, idColumn: DbColumnEditor) : Int =
    DriverManager.getConnection(url)
        .use {
            val logger: Logger = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME)
...
fun count(url : String, table: String, filters: List<Filter<*>>, idColumn: DbColumnEditor) : Int =
    DriverManager.getConnection(url)
        .use {
            val logger: Logger = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME)
